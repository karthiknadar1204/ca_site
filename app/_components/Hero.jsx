...
const utilities = [
  {
    name: "PAN Search",
    link: "https://incometaxindiaefiling.gov.in/portal/knowpan.do",
  },
  {
    name: "TAN Search",
    link: "https://incometaxindiaefiling.gov.in/e-Filing/Services/KnowYourTanLink.html",
  },
  { name: "Currency Converter", link: "https://www.xe.com/currencyconverter/" },
  {
    name: "Online Payment of Taxes",
    link: "https://www.incometax.gov.in/iec/foportal/help/all-topics/e-filing-services/working-payments/e-pay-tax-1",
  },
  {
    name: "Income Tax Refund Status",
    link: "https://www.incometax.gov.in/iec/foportal/help/all-topics/e-filing-services/filing-your-return/check-refund-status",
  },
  {
    name: "Challan Status Enquiry",
    link: "https://www.incometax.gov.in/iec/foportal/help/challan-status-inquiry-faqs",
  },
  { name: "e-filing", link: "https://eportal.incometax.gov.in/" },
  { name: "MCA21(ROC)", link: "https://www.mca.gov.in/mcafoportal/" },
  {
    name: "GST Registration",
    link: "https://services.gst.gov.in/services/quicklinks/registration",
  },
    ...
    <div className="flex flex-col lg:flex-row">
      ...
      <div className="w-full lg:w-2/4 p-4">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-2xl lg:text-3xl font-bold bg-gray-200 text-blue-600 p-2 mb-4">
            Welcome to Ankur A Gupta & Associates
          </h1>
          <div className="flex flex-col lg:flex-row items-center mb-4">
            ...
            <div>
              <p className="text-lg lg:text-xl">
                MDS Associates is a Proprietorship Chartered Accountancy <br />{" "}
                Firm established in the year 2012. We are a practicing Chartered{" "}
                <br /> Accountancy firm specializing in auditing, accounting,
                taxation, <br /> management services, corporate services etc.
              </p>
            </div>
          </div>
          <div className="mt-8 text-lg lg:text-xl">
            <p>
              Our aim is to provide real value to our clients in return for
              their confidence in us as their consultants.
              <br />
              Being fresh in the industry, we have the zeal to excel in our
              service and provide the highest degree of <br /> customer
              satisfaction to our clients. We accomplish this by forming
              one-to-one relationships with them,
              <br /> listening and analyzing carefully to their specific needs,
              and bringing together our broad resources to <br /> address those
              needs.
            </p>
          </div>

          <h1 className="text-2xl lg:text-3xl font-bold bg-gray-200 text-blue-600 mt-12 p-2 mb-4">
            Vision
          </h1>
          <p className="mb-4 text-lg lg:text-xl">
            To be amongst the most respected and leading professional firms by
            providing quality professional service with highest standards of
            integrity, specialization & dedication to domestic as well as global
            clients.
          </p>
      ...
      <div className="w-full lg:w-1/4 bg-white p-4 border-l border-gray-300">
        ...
        <div className="mt-8 p-4 bg-gray-100 border border-gray-300 rounded">
          ...
          <form>
            ...
            >
              <a href="https://mdsassociate.in/" target="_blank">
                Login
              </a>
            </button>
          </form>
